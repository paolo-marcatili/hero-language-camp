    ...
    <HomeDashboard
      ...
      content={trainingMenuOpen ? (
        ...
        <>
          ...
          <StoryPanel key={`${pack.pack_id}:${pack.version}:${learnerState.level}`} pack={pack} state={learnerState} language={baseLanguage} alternateLanguage="it" alternateLanguageLabel="Italiano" />
        </>
      )}
    />
  );
